...
function NavItems({ isModalView = false, isAdminView, router }) {
  return (
    ...
    >
      <ul
        className={
          'flex flex-col p-4 md:p-0 mt-4 font-medium rounded-lg md:flex-row md:space-x-8 md:mt-0 md:border-0 bg-white ${isModalView ? "border-none" : "border border-gray-100"}'
        }
      >
        {isAdminView
